...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4511865130&password=CZY-JMJ0ZZQCO-NEXU"
    elif r == "BD":
        return "uid=4511869400&password=CZY-57JZMCJUB-NEXU"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4511876973&password=CZY-JBUNOTUWV-NEXU"
    else:
        return "uid=4512004035&password=DEV_Q76VG_BY_SPIDEERIO_GAMING_0DWLY"
...
def get_account_info():
    return asyncio.run(handle_account_info())
